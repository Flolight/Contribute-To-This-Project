# [Contribuez à ce projet](https://syknapse.github.io/Contribute-To-This-Project/)

[![Tweet](https://img.shields.io/twitter/url/http/shields.io.svg?style=social)](https://twitter.com/intent/tweet?text=Contribute%20To%20This%20Project.%20An%20easy%20project%20for%20first-time%20contributors,%20with%20a%20full%20tutorial.%20By%20@Syknapse&url=https://github.com/Syknapse/Contribute-To-This-Project&hashtags=100DaysofCode 'Tweet this project')

> **Annonce:** Êtes-vous intéressé pour devenir mainteneur de ce projet et aider à le poursuivre ? Si vous êtes intéressé•e, envoyez un DM à [Twitter](https://twitter.com/Syknapse) et jetez un oeil au [guide du mainteneur](maintainer_guide.md).

## Introduction

Voici un tutoriel pour aider les contributeurs et contributeuses débutants à participer à un projet simple et accessible.

Ce tutoriel est aussi disponible dans [d'autres langues](https://github.com/Syknapse/Contribute-To-This-Project/tree/master/translations) ([Anglais](https://github.com/Syknapse/Contribute-To-This-Project/blob/master/README.md), [Portugais](https://github.com/Syknapse/Contribute-To-This-Project/blob/master/translations/PORTUGUESE.md), [Espagnol](https://github.com/Syknapse/Contribute-To-This-Project/blob/master/translations/SPANISH.md), [Italian](https://github.com/Syknapse/Contribute-To-This-Project/blob/master/translations/ITALIAN.md) et [Français](https://github.com/Syknapse/Contribute-To-This-Project/blob/master/translations/FRENCH.md) pour l'instant).

Toute autre traduction est bienvenue.

### Objectifs

- Réaliser une contribution à un projet open source.
- Être plus à l'aise dans l'utilisation de GitHub.

### Pour qui est ce tutoriel ?

- Il est pour les vrais débutants et débutantes. Si vous savez comment ajouter et modifier une balise d'ancrage  `<a href="" target=""></a>` alors vous devriez être capable de le suivre.
- Il est aussi pour ceux et celles qui ont un peu plus d'expérience mais qui veulent faire leur première contribution open source, ou réaliser davantage de contributions pour gagner en expérience et en confiance.

### Pourquoi dois-je faire ça?

Tous les développeurs (ou développeuses), débutants ou expérimentés doivent utiliser le gestionnaire de version Git, et GitHub est le service d'hébergement Git le plus populaire utilisé.
Il est aussi le coeur de la communauté open source. Devenir à l'aise dans l'utilisation de GitHub est une compétence essentielle.
Contribuer à un projet permet de gagner en confiance et permet de remplir son profil GitHub.<br>
Si vous êtes un nouveau développeur, ou une nouvelle développeuse, et que vous vous demandez si vous devez apprendre Git et GitHub alors voici la réponse: [Vous auriez du apprendre Git hier](https://codeburst.io/number-one-piece-of-advice-for-new-developers-ddd08abc8bfa 'New Developer? You should’ve learned Git yesterday. by Brandon Morelli, creator of CodeBurst.io').

## Comment vais-je contribuer ?

![Carte de contribution](readme-only/card.PNG 'Contributor Card')

Vous allez contribuer en ajoutant une carte comme celle-ci à la [page web du projet](https://syknapse.github.io/Contribute-To-This-Project/ 'https://syknapse.github.io/Contribute-To-This-Project').
Ell contiendra votre nom, votre pseudo Twitter, une courte description, et 3 liens vers des ressources utiles au développement web que vous recommandez.

Vous ferez une copie du modèle de carte dans le fichier HTML et le personnaliserez avec vos propres informations.

## Sommaire

| <ul><li>[Introduction](#introduction)</li><li>[Comment vais-je contribuer ?](#comment-vais-je-contribuer-?)</li><li>[Configuration](#configuration)</li><li>[Contribuer &rightarrow;](#contribuer)</li><li>[2tapes suivantes](#etapes-suivantes)</li><li>[Remerciements](#remerciements)</li></ul> | Contribuer: <ul><li>[Étape 1: Forker le dépôt](#etape-1-forker-le-depot)</li><li>[Étape 2: Cloner le dépôt ](#etape-2-cloner-le-depot)</li><li>[Étape 3: Créer une nouvelle branche](#etape-3-creer-une-nouvelle-branche)</li><li>[Étape 4: Ouvrir le fichier index.htlm](#etape-4-ouvrir-le-fichier-indexhtml)</li><li>[Étape 5: Copier le modèle de carte](#etape-5-copier-le-modele-de-carte)</li><li>[Étape 6: Appliquer vos changements](#etape-6-appliquer-vos-changements)</li><li>[Étape 7: Committer vos changements](#etape-7-committer)</li><li>[Étape 8: Pousser vos changements vers GitHub](#etape-8-pousser-vos-changements-vers-github)</li><li>[Étape 9: Soumettre une Pull Request](#etape-9-soumettre-une-pull-request)</li><li>[Étape 10: Célébrer !](#etape-10-celebrer)</li></ul> |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
